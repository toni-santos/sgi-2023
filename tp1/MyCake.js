...
class MyCake extends THREE.Object3D {
     ...
     * @param {number} segments the radial segments of the cake
     * @param {number} color the main color of the cake
     * @param {number} candles the amount of candles in the cake
     */
