...
class MyWindow extends THREE.Object3D {
    constructor(app, width, height, color, landscapeTexture) {
        ...
        this.outerFrame = new MyFrame(this.app, this.width, this.height, 5, 0xffffff);
        ...
        this.gridHMesh = new THREE.Mesh(this.gridH, this.outerFrame.frameMaterial);
        this.gridHMesh.position.set(0, 0, this.depth/2);

        this.gridV = new THREE.BoxGeometry(this.depth, this.height, this.depth);
        this.gridVMesh = new THREE.Mesh(this.gridV, this.outerFrame.frameMaterial);
